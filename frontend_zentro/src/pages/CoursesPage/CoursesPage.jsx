  ...
  return (
    <div className="courses-page">
      <div className="courses-container">
        <SEO 
          title="Courses" 
          description="Explore courses offered by Uyaron Technology."
        />
        ...
        <div className="course-section" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="academy-section" data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="certificate-section" data-aos="fade-up" data-aos-delay="300">
          <div className="certificate-image">
            <img 
              src="/assets/certificate.png" 
              alt="Uyaron Certificate" 
              loading="lazy" 
              decoding="async" 
            />
          </div>
